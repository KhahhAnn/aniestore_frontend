...
import anbk from "../../assets/anbk.jpg"
import huyenntt from "../../assets/huyenbtt.jpg"
      ...
      <div className=''>
         ...
         <div>
            <div className='flex justify-center gap-10 text-center mt-10'>
               <div>
                  <div className='conainer-scale'>
                     <img className='w-[300px] h-[300px] rounded-lg scale' src={anbk} alt='' />
                     <div className='absolute z-10 top-[1590px] ml-[90px] flex gap-5 justify-center team-icon'>
               ...
               <div>
                  <div className='conainer-scale'>
                     <img className='w-[300px] h-[300px] rounded-xl scale' src={huyenntt} alt='' />
                     <div className='absolute z-10 top-[1590px] ml-[90px] flex gap-5 justify-center team-icon'>
