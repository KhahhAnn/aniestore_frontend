      ...
      <div>
         <form onSubmit={handleSubmit}>
            <Grid container spacing={3}>
               ...
               <Grid item xs={12}>
                  <Button className='bg-[#9155FD] w-full' type='submit' variant='contained' size='large' sx={{ padding: "0.8rem 0", bgcolor: "#9155FD" }}>Register</Button>
               </Grid>
            </Grid>
         </form>
         <div className='flex justify-center flex-col items-center'>
            <div className='py-3 flex items-center'>
               ...
               <Button onClick={() => navigate("/login")} className='ml-5 mt-2' size='small' sx={{ marginTop: "4px" }}>Login</Button>
            </div>
         </div>
      </div>
   )
